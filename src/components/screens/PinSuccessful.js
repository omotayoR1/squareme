...
const PinSuccessful = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Pin Set Successful!</Text>
      <Text style={styles.subHeader}>Your security pin has been set successfully.</Text>
